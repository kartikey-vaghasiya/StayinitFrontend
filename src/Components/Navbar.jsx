...
import { useAuth, AuthContextJSX } from './utils/AuthContexJSX'
...
export default function Navbar() {
    ...
    const { loginData, logoutContextFunction } = useAuth()
    const { isLoggedIn } = loginData

    return (
        <div className="relative w-full bg-colorY shadow-sm px-[2rem] md:px-[6rem] ">
                            ...
                            (
                                <div className="">
                                    <div key="User">
                                        ...
                                        >
                                            <div className='text-xl flex flex-row gap-3 py-2 px-5 items-center hover:bg-colorYH rounded-[2rem]'>
                                                <img src="/icons/user.png" className='w-5 h-5' alt="" /> <span>User</span>
                                            </div>
                                        </Link>
                                    </div>
                                </div>
